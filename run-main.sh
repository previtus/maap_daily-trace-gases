...
export PYTHONPATH="$BASEDIR/daily_trace_gases:$PYTHONPATH"
...
echo "daily_trace_gases codebase run!"
python ${BASEDIR}/daily_trace_gases/detect_trace_gases.py -tile $1 -gas $2 -basedir ${BASEDIR}/daily_trace_gases/ -results_folder ${OUTPUTDIR}
...
python ${BASEDIR}/daily_trace_gases/prepare_and_upload_results.py -tile $1 -gas $2 -basedir ${BASEDIR}/daily_trace_gases/ -results_folder ${OUTPUTDIR}
